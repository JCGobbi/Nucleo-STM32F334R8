...
package Inverter_ADC is
   ...
   Battery_Relation : constant Float := 10_000.0 / (100_000.0 + 10_000.0);
   ...
   --  Inverter nominal electrical power.
   ...
   Output_Relation : constant Float := 10_000.0 / (100_000.0 + 10_000.0);
