...
# Added for stm32f3x4
    'stm32f3x4':         {'STM32_Main_Clock_Frequency': '72_000_000',
                          'STM32_HSE_Clock_Frequency': '8_000_000',
...
# Added for stm32f3x4
        if self.mcu.startswith('stm32f3'):
           self.add_gnat_sources(
               'arm/stm32/stm32f3x4/s-bbpara.ads',
               'arm/stm32/stm32f3x4/s-stm32.ads',
               'arm/stm32/stm32f3x4/start-rom.S',
               'arm/stm32/stm32f3x4/start-ram.S',
               'arm/stm32/stm32f3x4/setup_pll.adb',
               'arm/stm32/stm32f3x4/setup_pll.ads',
               'arm/stm32/stm32f3x4/s-bbbopa.ads')
           self.add_linker_script('arm/stm32/stm32f3x4/common-RAM.ld', loader='RAM')
           self.add_linker_script('arm/stm32/stm32f3x4/common-ROM.ld', loader='ROM')
        else:
           self.add_gnat_sources(
               'src/s-bbpara__stm32f4.ads',
               'arm/stm32/s-stm32.ads',
...
# Added for stm32f3x4
        if not self.mcu.startswith('stm32f3'):
# End
...
# Added for stm32f3x4
            ...
            self.add_gnat_source('arm/stm32/stm32f3x4/s-stm32.adb')
# End
